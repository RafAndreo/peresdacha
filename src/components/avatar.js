...
class Avatar extends Component {
    ...
    setStyle(mainDiv){
        mainDiv.style.background = `linear-gradient(${this.getDegree()}, rgb(${this.getColor()},${this.getColor()},${this.getColor()}),rgb(${this.getColor()},${this.getColor()},${this.getColor()}),rgb(${this.getColor()},${this.getColor()},${this.getColor()})), url(https://html5book.ru/wp-content/uploads/2016/12/photo-8.jpg)`
    }
